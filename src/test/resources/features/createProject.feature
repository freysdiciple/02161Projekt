...
# 	When 5- the user creates a project with a number 12345
...
#	Given 5- there is an user with ID "Søren"
#	And 5- the user is an admin
#	When 5- the user creates a project with a number 12345 identical to an existing project
...
#   When 5- the user tries to create a project with a number 12345
